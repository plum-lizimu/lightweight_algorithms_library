...
base_config = {
    ...
    "pruning_model": {
        ...
        "ckpt": '/home/saih/lightweight_algorithms_library/kd/teacher_model/resnet34-183-best_cifar100.pth',
        "save_path": '/home/saih/lightweight_algorithms_library/kd/teacher_model/'
    },
    "experiment_config": {
        "device": "cuda:0",
        ## 剪枝后的微调次数
