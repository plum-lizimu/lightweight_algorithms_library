...
from data import InstrcutDataSet, data_collate
...
def get_args_parser():
    ...
    parser.add_argument('--warmup_epochs', type=int, default=0.1, metavar='N',
    ...
    parser.add_argument('--data_root', type=str, default='/data/zfy/dataset/llava1.5')

    parser.add_argument('--pretrain_model', type=str, default='/data/zfy/output_dir/pretrained-3.pth', help='pre-trained model path')
...
def main(args):
    ...
    dataset_train = InstrcutDataSet(args, args.llama_model_path, args.max_seq_len)
