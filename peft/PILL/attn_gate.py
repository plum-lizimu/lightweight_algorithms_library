...
from model.llm_model import apply_rotary_emb
...
def main(
    ...
    # adapter_path: str='/data/zfy/pill/output_dir/checkpoint-19.pth',
    adapter_path: str='/data/zfy/stich_adapter/91.30.pth',
    ...
    image_path = os.path.join(data_root, split)
    ...
    prompt_args.random_select_rate=0
    ...
    for i in range(total_items//max_batch_size+1):
        ...
        for qid in batch_qids:
            ...
            if problems[qid]['image'] is not None:
                ...
                prompt = prompt.replace("Image:N/A", "Image:<image>"+"<image_placeholder>"*32)
            else:
        ...
        results = generator.generate(
            prompts, images=images, max_gen_len=1, temperature=generation_temperature, top_p=top_p
        )
