...
from peft_adapter import peft_adapter
...
def Llama(args, **kwargs):
    ...
    ### 填充adapter的params参数
    for _adapter in adapter_config['Adapter_list']:
        _adapter['params']['args'] = model_args
    adapter_config['block_num'] = model_args.n_layers
    ...
    llama, hook_list = peft_adapter(llama, adapter_config, model_args=model_args)
    ...
    print('Number of trainable params: %.2fM' % (total / 1024 / 1024))
    return llama, hook_list